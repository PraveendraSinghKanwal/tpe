...
from app.features.survey_analysis.schemas import (
    SurveyInput,
    SurveyAnalysisResponse,
    SurveyStatusResponse,
    ErrorResponse
)
from app.features.survey_analysis.services import SurveyAnalysisService
from app.features.survey_analysis.repository import SurveyRepository
    ...
    async def get_survey_analysis(
        ...
        try:
            ...
            for analysis in analysis_results:
                from app.features.survey_analysis.schemas import CategoryAnalysis
